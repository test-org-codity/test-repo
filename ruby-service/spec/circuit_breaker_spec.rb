...
RSpec.describe CircuitBreaker::Breaker do
  ...
  describe '#execute' do
    ...
    it 'runs the block and returns its result on success' do
  ...
  describe '#state transitions' do
    ...
    it 'limits calls in HALF_OPEN to half_open_max_calls' do
      2.times do
        expect do
          breaker.execute do
            raise 'boom'
    ...
    it 'opens due to failure rate exceeding threshold even before failure_threshold' do
      ...
      b = described_class.new('rate-test', config: cfg)
